...
data class InvalidCourseDescriptionException(val description: String) : InvalidArgumentCourseException("The description <$description> is not a valid course description")
